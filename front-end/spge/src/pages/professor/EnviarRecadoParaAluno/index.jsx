...
export default function EnviarRecadoParaAluno(){

  const {recado, preencherRecado, enviarFormularioEnviarRecadoParaAluno} = useRecado();
  ...
  return(
    ...
    >
      ...
      <FormRecado
        ...
        enviarFormulario={enviarFormularioEnviarRecadoParaAluno}
      />
    </Container>
  )
}